...
INFRA_CONFIG_PATH=./configs/vic3d/late-fusion-image-pointcloud/mvxnet/trainval_config_i.py
INFRA_MODEL_PATH=./checkpoints/infrastructure-side/mvxnt/latest.pth

VEHICLE_CONFIG_PATH=./configs/vic3d/late-fusion-image-pointcloud/mvxnet/trainval_config_v.py
VEHICLE_MODEL_PATH=./checkpoints/vehicle-side/mvxnt/latest.pth
