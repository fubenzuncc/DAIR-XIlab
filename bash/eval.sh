...
# bash ./bash/eval_lidar_late_fusion_pointpillars_mvx.sh 0 late_fusion 0 0 100 --no-comp

bash ./bash/eval_lidar_late_fusion_pointpillars_testA.sh 0 late_fusion 0 0 100 --no-comp
# bash ./bash/eval_lidar_late_fusion_pointpillars_second.sh 0 late_fusion 0 0 100 --no-comp
