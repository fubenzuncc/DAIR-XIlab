...
OUTPUT_DIR=/workspace/mnt/storage/guangcongzheng/zju_fbz_backup/DAIR-V2X-val/eval_lidar_camera_inf_official_pointpillars_veh_official_pointpillars_scale1.25
...
#VEHICLE_CONFIG_NAME="trainval_config_v_960_540_rot0.25.py"
#VEHICLE_MODEL_NAME="epoch_60.pth"

VEHICLE_MODEL_PATH=configs/vic3d/late-fusion-pointcloud/pointpillars
VEHICLE_CONFIG_NAME="trainval_config_v_scale1.25.py"
...
CUDA_VISIBLE_DEVICES=1 python v2x/eval.py \
  --input ${DATA_DIR} \
  --output ${OUTPUT_DIR} \
  --model late_fusion \
  --dataset vic-async \
