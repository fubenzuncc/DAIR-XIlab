...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/workspace/infrastructure-side/bevfusion_zgc"
...
model = dict(
    ...
    encoders=dict(
        ...
        lidar=dict(
            ...
            #     type="SparseEncoder",
            #     in_channels=4,
            #     sparse_shape=[height, length, z_num+1],
            #     order=("conv", "norm", "act")
            # ),
        ),
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(type="ImageAug3D", final_dim=image_size, resize_lim=[0.38, 0.55], bot_pct_lim=[0.0, 0.0], rot_lim=[-5.4, 5.4], rand_flip=True, is_train=True),
