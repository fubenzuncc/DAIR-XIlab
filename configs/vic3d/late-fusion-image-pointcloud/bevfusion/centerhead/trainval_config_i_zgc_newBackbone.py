...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/workspace/infrastructure-side/bevfusion_zgc_newBackbone"
    ...
    encoders=dict(
        camera=dict(
            ...
            vtransform=dict(
                ...
                # dbound=[1.0, 60.0, 0.5],
                xbound=[0, 92.16, 0.256], # (92.16-0) / 2 / 0.256 = 180
                ybound=[-40, 40, 0.222],
                zbound=[-1, 3, 4],
                dbound=[1.0, 60.0, 0.5],
                downsample=2
