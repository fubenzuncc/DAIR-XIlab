...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug1_load_lidar"
...
log_level = "INFO"
load_from = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug0_lidar_20epoch/epoch_10.pth"
resume_from = None
workflow = [("train", 1)]
gpu_ids = range(0, 8)
