...
data_root_i = "./data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/"
...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug1_2dataset_vi"
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type="KittiDataset",
            data_root=data_root,
            ann_file=[data_root + "/kitti_infos_train.pkl", data_root_i + "/kitti_infos_train.pkl"],
            split="training",
