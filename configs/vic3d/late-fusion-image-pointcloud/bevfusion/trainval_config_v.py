...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/bevfusion_200"
...
# lr = 0.0002
optimizer = dict(type="AdamW", lr=0.0002, betas=(0.95, 0.99), weight_decay=1e-4)
