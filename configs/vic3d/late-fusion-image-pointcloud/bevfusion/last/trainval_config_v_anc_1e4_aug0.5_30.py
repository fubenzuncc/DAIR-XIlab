...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/final/aug0.5_epoch_final"
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(type="GlobalRotScaleTransBEVFusion", resize_lim=[0.9, 1.1], rot_lim= [-0.2, 0.2], trans_lim=0.2,is_train=True),
