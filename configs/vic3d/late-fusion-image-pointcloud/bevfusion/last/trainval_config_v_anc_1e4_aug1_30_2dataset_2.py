...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/final/anc_1e4_aug1_2dataset_2"
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type="KittiDataset",
            data_root=data_root,
            ann_file=[data_root + "/kitti_infos_train.pkl", data_root + "/kitti_infos_val.pkl"],
            split="training",
...
log_level = "INFO"
load_from = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/final/anc_1e4_aug1_2dataset/latest.pth"
resume_from = None
workflow = [("train", 1)]
gpu_ids = range(0, 8)
