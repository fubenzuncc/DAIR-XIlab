...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/bevfusion_1e_5_aug1"
...
lr = 1e-5
optimizer = dict(type="AdamW", lr=1e-5, betas=(0.95, 0.99), weight_decay=1e-4)
