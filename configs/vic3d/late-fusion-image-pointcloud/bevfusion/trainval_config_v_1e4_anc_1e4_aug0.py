...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug0"
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(type="ImageAug3D", final_dim=[256, 704], resize_lim=[0, 0], bot_pct_lim=[0.0, 0.0],rot_lim=[-5.4, 5.4],rand_flip=True,is_train=False),
