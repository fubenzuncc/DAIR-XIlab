...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug1_200"
...
log_level = "INFO"
load_from = None
resume_from = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/anc_1e4_aug1/latest.pth"
workflow = [("train", 1)]
gpu_ids = range(0, 8)
