...
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/vehicle-side/bevfusion_fine"
...
log_level = "INFO"
resume_from = None
load_from = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/infrastructure-side/bevfusion_i_randombev0/latest.pth"
workflow = [("train", 1)]
gpu_ids = range(0, 8)
