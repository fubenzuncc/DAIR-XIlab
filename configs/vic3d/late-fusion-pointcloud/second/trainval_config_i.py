...
point_cloud_range = [0, -40, -3, 92, 40, 1]
...
log_level = 'INFO'
work_dir = "/workspace/mnt/storage/guangcongzheng/zju_zgc/DAIR-V2X/checkpoints/infrastructure-side/second_80epochs"
load_from = None
resume_from = None
workflow = [('train', 1)]
